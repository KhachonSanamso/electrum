...
class PluginsDialog(WindowModalDialog):
    ...
    def show_list(self):
        descriptions = [x for x in self.plugins.find_all_plugins().values() if x.get('registers_keystore') is None]
        ...
        self.scroll_w.setMinimumHeight(len(descriptions) * 35)
